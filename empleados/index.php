...
if(isset($_GET["insertar"])){
    ...
    $nombre=$data->nombre;
    $correo=$data->correo;
    ///////agregamos esta linea 05////////////////
    $curso=$data->curso;
    $nivel=$data->nivel;
        if(($correo!="")&&($nombre!="")&&($curso!="")&&($nivel!="")){
            
    $sqlEmpleaados = mysqli_query($conexionBD,"INSERT INTO empleados(nombre,correo,curso,nivel) VALUES('$nombre','$correo','$curso','$nivel') ");
    echo json_encode(["success"=>1]);
        }
    exit();
}
...
if(isset($_GET["actualizar"])){
    ...
    $sqlEmpleaados = mysqli_query($conexionBD,"UPDATE empleados SET nombre='$nombre',correo='$correo',curso='$curso',nivel='$nivel' WHERE id='$id'");
    echo json_encode(["success"=>1]);
    exit();
}
